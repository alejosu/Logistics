                ...
                <div class="panel-body">
                    <table class="table table-condensed table-hover">
                        <thead>
                            <th>Nombre</th>
                            <th></th>
                            <th><a href="crearCiudad" class="btn btn-primary btn-xs pull-right glyphicon glyphicon-plus"></a></th>
                        </thead>
                        <tbody>
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a class="btn btn-danger pull-right" href="borrarCiudad/{{ $ciudad->id }}" >Borrar</a>
                                      </div>
                                    </div><!-- /.modal-content -->
                                  </div><!-- /.modal-dialog -->
                                </div><!-- /.modal -->
